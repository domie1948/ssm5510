		...
		<el-form ref="form" :model="form" status-icon label-width="120px" v-if="is_view()">
			<el-col v-if="user_group === '管理员' || $check_field('get','consultant_name') || $check_field('add','consultant_name') || $check_field('set','consultant_name')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="咨询师姓名" prop="consultant_name">
					<el-input id="consultant_name" v-model="form['consultant_name']" placeholder="请输入咨询师姓名"
							  v-if="user_group === '管理员' || (form['consulting_information_id'] && $check_field('set','consultant_name')) || (!form['consulting_information_id'] && $check_field('add','consultant_name'))" :disabled="disabledObj['consultant_name_isDisabled']"></el-input>
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','consultant_user') || $check_field('add','consultant_user') || $check_field('set','consultant_user')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="咨询师用户" prop="consultant_user">
						<el-select v-if="user_group === '管理员' || (form['consulting_information_id'] && $check_field('set','consultant_user')) || (!form['consulting_information_id'] && $check_field('add','consultant_user'))" id="consultant_user" v-model="form['consultant_user']" :disabled="disabledObj['consultant_user_isDisabled']">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','consultant_gender') || $check_field('add','consultant_gender') || $check_field('set','consultant_gender')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="咨询师性别" prop="consultant_gender">
					<el-input id="consultant_gender" v-model="form['consultant_gender']" placeholder="请输入咨询师性别"
							  v-if="user_group === '管理员' || (form['consulting_information_id'] && $check_field('set','consultant_gender')) || (!form['consulting_information_id'] && $check_field('add','consultant_gender'))" :disabled="disabledObj['consultant_gender_isDisabled']"></el-input>
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','consulting_direction') || $check_field('add','consulting_direction') || $check_field('set','consulting_direction')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="咨询方向" prop="consulting_direction">
					<el-input id="consulting_direction" v-model="form['consulting_direction']" placeholder="请输入咨询方向"
							  v-if="user_group === '管理员' || (form['consulting_information_id'] && $check_field('set','consulting_direction')) || (!form['consulting_information_id'] && $check_field('add','consulting_direction'))" :disabled="disabledObj['consulting_direction_isDisabled']"></el-input>
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','reply_status') || $check_field('add','reply_status') || $check_field('set','reply_status')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="回复状态" prop="reply_status">
					<el-select id="reply_status" v-model="form['reply_status']"
						v-if="user_group === '管理员' || (form['consulting_information_id'] && $check_field('set','reply_status')) || (!form['consulting_information_id'] && $check_field('add','reply_status'))">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','user_name') || $check_field('add','user_name') || $check_field('set','user_name')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="用户姓名" prop="user_name">
					<el-input id="user_name" v-model="form['user_name']" placeholder="请输入用户姓名"
							  v-if="user_group === '管理员' || (form['consulting_information_id'] && $check_field('set','user_name')) || (!form['consulting_information_id'] && $check_field('add','user_name'))" :disabled="disabledObj['user_name_isDisabled']"></el-input>
					<div v-else-if="$check_field('get','user_name')">{{form['user_name']}}</div>
				</el-form-item>
			</el-col>
			<el-col v-if="user_group === '管理员' || $check_field('get','consulting_users') || $check_field('add','consulting_users') || $check_field('set','consulting_users')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
				<el-form-item label="咨询用户" prop="consulting_users">
						<div v-if="user_group !== '管理员'">
							{{ get_user_session_consulting_users(form['consulting_users']) }}
							<!--<el-input id="business_name" v-model="form['consulting_users']" placeholder="请输入咨询用户"-->
							<!--v-if="user_group === '管理员' || (form['consulting_information_id'] && $check_field('set','consulting_users')) || (!form['consulting_information_id'] && $check_field('add','consulting_users'))" :disabled="disabledObj['consulting_users_isDisabled']"></el-input>-->
							<!--<div v-else-if="$check_field('get','consulting_users')">{{form['consulting_users']}}</div>-->
							<el-select v-if="user_group === '管理员' || (form['consulting_information_id'] && $check_field('set','consulting_users')) || (!form['consulting_information_id'] && $check_field('add','consulting_users'))" id="consulting_users" v-model="form['consulting_users']" :disabled="disabledObj['consulting_users_isDisabled']">
			...
			<el-col v-if="user_group === '管理员' || $check_field('get','consultation_reply') || $check_field('add','consultation_reply') || $check_field('set','consultation_reply')" :xs="24" :sm="12" :lg="8" class="el_form_item_warp">
