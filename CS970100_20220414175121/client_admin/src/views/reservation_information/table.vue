<template>
	<el-main class="bg table_wrap">
		...
		<el-table :data="list" @selection-change="selectionChange" @sort-change="$sortChange" style="width: 100%" id="dataTable">
			...
			<el-table-column prop="reservation_user" label="预约用户"
				v-if="user_group == '管理员' || $check_field('get','reservation_user')" min-width="200">
				<template slot-scope="scope">
					{{ get_user_reservation_user(scope.row['reservation_user']) }}
				</template>
			</el-table-column>
			<el-table-column prop="reservation_information" label="预约信息"
				v-if="user_group == '管理员' || $check_field('get','reservation_information')" min-width="200">
			</el-table-column>
