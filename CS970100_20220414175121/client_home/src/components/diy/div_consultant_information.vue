<template>
	<div class="diy_details_box diy_div_consultant_information">
		<div class="warp">
			<div class="container">
					...
					<div class="view praise_wrap">
						...
						{{ praiseLen }}
							...
							<div class="details_btn_wrap">
								...
								<button class="btn btn-primary details_btn" v-if="$check_action('/consulting_information/edit','add')" @click="to_form('/consulting_information/edit')" >咨询 </button>
								<button class="btn btn-primary details_btn" v-if="$check_action('/consultant_information/details','set')" @click="change_praise()" >点赞</button>
								<button class="btn btn-primary details_btn" v-if="$check_action('/consultant_information/details','set')" @click="change_collect()" >收藏</button>
							</div>
						<!-- 富文本 -->
