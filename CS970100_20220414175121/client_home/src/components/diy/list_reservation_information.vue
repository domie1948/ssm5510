		...
		<div class="diy_view_table" v-else>
			<table class="diy_table">
				<tr class="diy_row">
					...
					<th class="diy_title" v-if="$check_field('get','reservation_user')">预约用户
					</th>
					<th class="diy_title" v-if="$check_field('get','reservation_information')">预约信息
					</th>
				</tr>
				<tr class="diy_row" v-for="(o,i) in list" :key="o+i">
					...
					<td class="diy_field diy_uid" v-if="$check_field('get','reservation_user')">
						<span>
							{{ get_user_name(o['reservation_user']) }}
						</span>
					</td>
					<td class="diy_field diy_text" v-if="$check_field('get','reservation_information')">
						<span>
							{{ o["reservation_information"] }}
						</span>
					</td>
				</tr>
			</table>
